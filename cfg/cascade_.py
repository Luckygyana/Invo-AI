...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/opt/ml/model/chunk.json',
        img_prefix='/opt/ml/model/chunk_images/',
...
log_level = 'INFO'
work_dir = '/opt/ml/model/Mmdetection/new_chunk_cascade_mask_rcnn_hrnetv2p_w32_20e'
load_from = None
resume_from = '/opt/ml/model/Mmdetection/new_chunk_cascade_mask_rcnn_hrnetv2p_w32_20e/epoch_30.pth'
workflow = [('train', 1)]